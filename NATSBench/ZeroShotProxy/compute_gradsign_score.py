...
The code is re-implemented by ourselves.
...
[Major modification]
We add the condition in Ln21~22 to detect modules that are not used, instead of zeroing gradients in Ln38, which results in incorrect scores due to the "mean" operation in Ln43.
'''

...
def compute_nas_score(model, gpu, trainloader, resolution, batch_size, fp16=False):
    ...
    ################ fwrd pca score ################
    """
    pca score across residual block features / normalize each score by upper bound / minimum
    """
    scores = []
    ...
    ################ fwrd norm score ################
    """
    L2 norm preserving after matching the resolution / residual block features / minimum
    """
    scores = []
    ...
    ################ spec norm score ##############
    """
    spec norm score across residual block features / minimum
    """
    scores = []

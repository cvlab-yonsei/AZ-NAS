...
OPS = {
    ...
    "nor_conv_3x3": lambda C_in, C_out, stride, affine, track_running_stats: QReLUConvBN(
        C_in,
        C_out,
        (3, 3),
        (stride, stride),
    ...
    "nor_conv_1x1": lambda C_in, C_out, stride, affine, track_running_stats: QReLUConvBN(
        C_in,
        C_out,
        (1, 1),
        (stride, stride),
...
class QReLUConvBN(nn.Module):
    def __init__(
        ...
        super(QReLUConvBN, self).__init__()

...
save_dir=./save_dir/ETF16_flops450M-resblockfeat-searchbs128-randinput-pop512-iter1e5-flops
mkdir -p ${save_dir}
...
# python evolution_search_etf_flops.py --gpu 1 \
#   --zero_shot_score ETF16 \
